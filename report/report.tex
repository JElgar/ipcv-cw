...
From the previous results it is clear that the hough circles implementation was not effective when there was object blocking the dartboard or the dartboard was at an angle meaing the shape of the dartboard in the gradient image was actually an ellipse. In order to improve the detector an alternative method would need to be added which could detect dartboards in these specific conditions.
